...
public enum GameItem {
	...
	MagicStone(new ItemContainer("magic_stone", "Magic Stone", Material.AMETHYST_SHARD, Rarity.Rare, ItemType.Misc)
			.addDescription(Component.text("Used to upgrade equipment!").color(TextColors.GRAY_DESCRIPTION))),
	LowQualityGeode(new ItemContainer("low_quality_geode", "Low Quality Geode", Material.STONE, Rarity.Common, ItemType.Misc)
			.setCustomModelData(CustomModelData.GEODE).setDismantlable(LootTable.LowQualityGeode)
			.addDescription(Component.text("The most common type of geode.").color(TextColors.GRAY_DESCRIPTION),
					Component.text("Bring this to a blacksmith to break open").color(TextColors.GRAY_DESCRIPTION),
					Component.text("for a chance to drop quality loot.").color(TextColors.GRAY_DESCRIPTION))),
	...
	EfficiencyRune(new ItemContainer("efficiency_rune", "Efficiency Rune", Material.PAPER, Rarity.Uncommon, ItemType.Rune)
			...
			.addDescription(Component.text("Apply to any harvesting tools at the rune station.").color(TextColors.GRAY_DESCRIPTION))),
	...
	SmeltingRune(new ItemContainer("smelting_rune", "Smelting Rune", Material.PAPER, Rarity.Uncommon, ItemType.Rune)
			...
			.addDescription(Component.text("Apply to mining & woodcutting tools at the rune station.").color(TextColors.GRAY_DESCRIPTION))),
	...
	SilktouchRune(new ItemContainer("silktouch_rune", "Silktouch Rune", Material.PAPER, Rarity.Uncommon, ItemType.Rune)
			...
			.addDescription(Component.text("Apply to tools at the rune station.").color(TextColors.GRAY_DESCRIPTION))),

	DamageRune(new ItemContainer("damage_rune", "Damage Rune", Material.PAPER, Rarity.Uncommon, ItemType.Rune)
			.setRune(Rune.Damage)
			.addDescription(Component.text("Apply to any weapons at the rune station.").color(TextColors.GRAY_DESCRIPTION))),
	...
	DefenseRune(new ItemContainer("defense_rune", "Defense Rune", Material.PAPER, Rarity.Uncommon, ItemType.Rune)
			...
			.addDescription(Component.text("Apply to any equipment piece at the rune station.").color(TextColors.GRAY_DESCRIPTION))),

	ManaRune(new ItemContainer("mana_rune", "Mana Rune", Material.PAPER, Rarity.Uncommon, ItemType.Rune)
			.setRune(Rune.Mana)
			.addDescription(Component.text("Apply to any weapon or piece of equipment ").color(TextColors.GRAY_DESCRIPTION), Component.text("at the rune station.").color(TextColors.GRAY_DESCRIPTION))),
	...
	AdminScythe(new ItemContainer("admin_scythe", "Admin Scythe", Material.NETHERITE_HOE, Rarity.Mythic, ItemType.Sword)
			.setDamage(1000000)
			.addDescription(Component.text("This is a hoe.").color(TextColors.GRAY_DESCRIPTION))),
	...
	ClassicBow(new ItemContainer("classic_bow", "Classic Bow", Material.BOW, Rarity.Unique, ItemType.Bow)
			...
			.addDescription(Component.text("It's just a bow.").color(TextColors.GRAY_DESCRIPTION))),
	...
	LumberjacksLegacy(new ItemContainer("lumberjacks_legacy", "Lumberjack's Legacy", Material.GOLDEN_AXE, Rarity.Unique, ItemType.Axe)
			.setDamage(10).setRuneSlots(5)
			.addDescription(Component.text("A forgotten Lumberjack wielded this axe.").color(TextColors.GRAY_DESCRIPTION))),
	...
	DiamondPickaxe(new ItemContainer("diamond_pickaxe", "Diamond Pickaxe", Material.DIAMOND_PICKAXE, Rarity.Legendary, ItemType.Pickaxe)
			...
			.addDescription(Component.text("A simple diamond pickaxe").color(TextColors.GRAY_DESCRIPTION))),
