...
public class MagicWandItem extends StatItem implements RightClickAbility, Runable, ParticleHelper {
	...
	public void onRightClick(JCore main, GamePlayer player, NBTGameItem item) {
		...
		NPC npc = main.getEntityManager().getRegistry().getByUniqueId(rayTrace.getHitEntity().getUniqueId());
