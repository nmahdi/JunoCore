package io.github.nmahdi.JunoCore.item.commands;
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args){
        if(cmd.getName().equalsIgnoreCase("gameitem")){
            ...
            if(args.length == 1){
                ...
                if(itemManager.getItem(args[0]) != null){
                    ((Player)sender).getInventory().addItem(ItemBuilder.buildGameItem(itemManager.getItem(args[0])));
                    return true;
                }
