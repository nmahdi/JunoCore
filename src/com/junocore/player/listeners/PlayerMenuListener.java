...
public class PlayerMenuListener implements Listener {
    ...
    private JGUI mainMenu = new JGUI("&fPlayer Menu", 6, true).addItem("stats", 14).addItem("bank", 23);
    ...
    private void buildAndOpenPlayerMenu(Player player){
        ...
        for (Map.Entry<String, Integer> set : mainMenu.getItems().entrySet()) {
            ...
            if(set.getKey().equals("bank")){
                inv.setItem(set.getValue() - 1, new ItemStackBuilder(Material.GOLD_NUGGET).setName("&6Bank").addLore(
